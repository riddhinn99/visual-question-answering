...
import matplotlib.pyplot as plt
    ...
    with open('model_architecture_after_training.json', 'r') as f:
        vqa_model = model_from_json(f.read())

    # Load weights into the new model
    vqa_model.load_weights('model_weights_after_training.h5')
    ...
    new_question = create_question_feature_test("this is a car")
    new_image = create_image_feature_test('sample_data_new/11.jpg',model)
